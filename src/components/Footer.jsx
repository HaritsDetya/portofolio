const navigation = {
  ...
  social: [
    {
      name: 'Linkedin',
      href: 'linkedin.com/in/muhammad-harits-detya-irawan-219767279',
      icon: (props) => (
...
export default function Footer() {
  return (
    <footer className="mt-32 bg-primary-soft_blue">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-10 sm:py-12 lg:px-8">
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {navigation.social.map((item) => (
            <a key={item.name} href={item.href} className="text-white hover:text-accent-pale_gold">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-white">
          &copy; 2024 Harits, All Right Serve
        </p>
      </div>
    </footer>
  )
